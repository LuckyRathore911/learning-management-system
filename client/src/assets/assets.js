...
export const dummyTestimonial = [
    {
        ...
        rating: 5,
        feedback: "I've been using CodeCampus for months, and it's transformed my learning experience! The platform is intuitive, and the coding exercises make practice effortless.",
    },
    {
        name: 'Vikram Pal',
        role: 'SWE 2 @ Samsung',
        ...
        rating: 4,
        feedback: "CodeCampus has made learning to code so much easier. The structured courses and interactive challenges keep me engaged and motivated!",
    },
    {
        name: 'Yami Manjhi',
        role: 'SWE 2 @ Google',
        ...
        rating: 4.5,
        feedback: "As an instructor, CodeCampus has streamlined my teaching process. The platform is user-friendly, and managing students' progress is a breeze!",
    },
];
